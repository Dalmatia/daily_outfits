    ...
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      ...
      <form class="max-w-lg border rounded-lg mx-auto" @submit.prevent="submit">
        <div class="flex flex-col gap-4 p-4 md:p-8">
          <div>
            <label for="outfit" class="inline-block text-gray-800 text-sm sm:text-base mb-2">
              コーディネート写真:
            </label>
            <input
              ...
              type="file" name="outfit" @input="grabFile" />
          ...
          <div>
            <label for="description"
              class="inline-block text-gray-800 text-sm sm:text-base mb-2">何か書く(コーディネートのポイントなど):</label>
            <textarea
              class="w-full bg-gray-50 text-gray-800 border rounded outline-none transition duration-100 px-3 py-2"
              maxlength="200" name="description" v-model="fields.description"></textarea>
          </div>

          <div>
            <label for="post_date" class="inline-block text-gray-800 text-sm sm:text-base">投稿日:
            </label>
            <Calendar class="w-full text-gray-800 rounded outline-none transition duration-100 px-3 py-3"
              input-id="post_date" dateFormat="yy-mm-dd" v-model="fields.post_date" :show-icon="true"
              placeholder="日付を選択する" />
