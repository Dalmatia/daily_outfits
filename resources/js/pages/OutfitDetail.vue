<template>
    <div class="container mx-auto">
        ...
        >
            ...
            <a
                href="#"
                class="float-right bg-blue-500 text-white font-semibold text-sm rounded text-center md:inline-block p-3"
            >
                フォロー
            </a>
        </div>
        ...
        >
            <div
                class="p-3 px-6 min-h-48 flex justify-center items-center"
                style="cursor: auto"
            >
                <custom-card3>
                    <div
                        class="rounded-md shadow-md sm:w-96 md:w-auto bg-white text-coolGray-100"
                    >
                        <img
                        ...
                        <div class="p-3" style="cursor: auto">
                            ...
                            <div
                                class="flex flex-wrap items-center pt-3 pb-1"
                                style="cursor: auto"
                            >
                            ...
                            <div class="space-y-3" style="cursor: auto">
                                ...
                                <input
                                    ...
                                    class="w-full py-0.5 bg-transparent border-none rounded text-sm pl-0 text-coolGray-100 outline-none"
                                    style="cursor: auto"
                                />
                            </div>
                        </div>
            ...
            <div class="sm:col-span-2 p-4" style="cursor: auto">
                <div class="bg-white rounded-lg shadow-md" style="cursor: auto">
                    <h4
                        class="text-lg leading-6 font-semibold font-sans text-skin-inverted group-hover:text-skin-primary border-b p-3"
                        style="cursor: auto"
                    >
                    ...
                    <p
                        class="mt-1 font-normal text-skin-base leading-5 m-4"
                        style="cursor: auto"
                    >
                        {{ outfit.description }}
                    </p>
                    <div
                        class="mt-3 flex items-center font-sans"
                        style="cursor: auto"
                    >
                        <div class="ml-3">
                            <div
                                class="flex space-x-1 text-sm text-skin-muted"
                                style="cursor: auto"
                            >
                    ...
                    >
                        ...
                        >
                            <span
                                class="inline-flex items-center leading-none px-2.5 py-1.5 text-sm font-medium text-skin-inverted rounded-full border border-skin-input bg-white"
                                style="cursor: auto"
                            >
                                <svg
                ...
                <div
                    class="mt-10 bg-white rounded-lg shadow-md"
                    style="cursor: auto"
                >
                    <h4
                        class="text-lg leading-6 font-semibold font-sans text-skin-inverted group-hover:text-skin-primary border-b p-3"
                    ...
                    <div
                        class="mt-5 flex space-x-2 items-center justify-center flex-wrap"
                    >
                        <div
                            class="story-item relative hover:opacity-90 cursor-pointer transition duration-200 ease-in-out"
                            style="width: 136px"
                        >
                            <img
                            ...
                            />
                            <div
                                class="absolute flex flex-col justify-between h-full w-full top-0 left-0 py-4"
                            >
                                <img
                                    src="https://picsum.photos/id/237/50/50"
                                    class="rounded-full w-10 h-10 border-4 border-blue-500 ml-4"
                                />
